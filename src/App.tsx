...
const EquationControl = (props: equationControlPropsType): JSX.Element => {
  ...
  const minDigitHandler: (event: ChangeEvent<HTMLInputElement>) => void = (
    event
  ) => {
    if (startStopState === "stop") {
      if (event) {
          ...
          <div className="d-flex flex-row flex-wrap align-items-center">
            ...
            >
              ...
              <input
                ...
                size={1}
                onChange={(event) => minDigitHandler(event)}
            ...
            >
              ...
              <input
                ...
                className="digitInput h4"
                size={1}
                onChange={(event) => maxDigitHandler(event)}
